...
4. **Phase 6 rename (complete)** — AcmeGate/AcmeSentinel middleware and `acme_*_guard_*` telemetry fields; sim sourcetype `acme:agentic:sim:json`; Cross-App Normalization dashboard.
