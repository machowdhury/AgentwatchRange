...
Dashboard Studio view: **Executive AI Governance** (`executive_governance.json`) — the default landing page for CISO, risk, and audit audiences in the GenAI Compliance Monitor app.
